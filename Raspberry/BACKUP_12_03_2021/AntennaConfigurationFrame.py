...
class AntennaConfigurationFrame(Tk.LabelFrame):
    ...
    iStepSizeYawDg = YAW_MOTOR_STEP_SIZE_IN_DEGREE   
    iStepSizePitchDg = PITCH_MOTOR_STEP_SIZE_IN_DEGREE   
    iMaxYawPossible = YAW_MOTOR_UPPER_LIMIT_IN_DEGREE
    iMinYawPossible = YAW_MOTOR_LOWER_LIMIT_IN_DEGREE
    iMaxPitchPossible = PITCH_MOTOR_UPPER_LIMIT_IN_DEGREE
    iMinPitchPossible = PITCH_MOTOR_LOWER_LIMIT_IN_DEGREE
    ...
    def applyButtonClicked(self):
        ...
        # TODO: Control pitch bounds
        # TODO: Control yaw bounds
        # TODO: Step size pitch
        # TODO: Step size yaw
