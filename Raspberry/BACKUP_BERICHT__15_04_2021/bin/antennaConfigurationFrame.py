...
class AntennaConfigurationFrame(Tk.LabelFrame):
    ...
    def create_widgets(self):
        ...
        self.stepsizePitchConstLabel = ttk.Label(master=self, text=("* " + str(PITCH_MOTOR_STEP_SIZE_IN_DEGREE) + "°"), background=AntennaConfigurationFrame.CONFIG_FRAME_BG_COLOR)
        self.stepsizePitchMinMaxLabel = ttk.Label(master=self, text=("[" + str(PITCH_MOTOR_MIN_STEP_MULIPLIER) + "," + str(PITCH_MOTOR_MAX_STEP_MULIPLIER) + "]"), background=AntennaConfigurationFrame.CONFIG_FRAME_BG_COLOR)
        ...
        self.stepsizeYawConstLabel = ttk.Label(master=self, text=("* " + str(YAW_MOTOR_STEP_SIZE_IN_DEGREE) + "°"), background=AntennaConfigurationFrame.CONFIG_FRAME_BG_COLOR)
        self.stepsizeYawMinMaxLabel = ttk.Label(master=self, text=("[" + str(YAW_MOTOR_MIN_STEP_MULIPLIER) + "," + str(YAW_MOTOR_MAX_STEP_MULIPLIER) + "]"), background=AntennaConfigurationFrame.CONFIG_FRAME_BG_COLOR)
        ...
        self.stepsizePitchMinMaxLabel.grid(row=6, column=3, ipadx=2)                
        ...
        self.stepsizeYawMinMaxLabel.grid(row=8, column=3, ipadx=2)        
    ...
    def changeLockState(self, locked):
        if locked:
            self.pitchFromEntryField.state(['disabled'])
            self.pitchToEntryField.state(['disabled'])
            self.yawToScanEntryField.state(['disabled'])
            self.stepsizePitchMultiplierSpinbox.state(['disabled'])
            self.stepsizeYawMultiplierSpinbox.state(['disabled'])
            self.nameLabelEntryField.state(['disabled'])
            ...
            raise Exception("Failing to (un)lock AntennaConfigurationFrame")
        return
