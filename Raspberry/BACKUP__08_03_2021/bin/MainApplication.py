...
class MainApplication(Tk.Frame):
    ...
    def create_section_antennaControl(self):
        ...
        self.antennaControlSection.pack(side="right", fill="both", expand=True, padx=2, pady=2)
        pass
    def create_sectiom_antennaState(self):
        self.antennaStateSection = aState.AntennaControlFrame(container=self, text="Antenna state")
        # self.antennaStateSection.grid(row=1, column=0, sticky="sw")
        self.antennaStateSection.pack(side="bottom", fill="both", expand=True, padx=2, pady=2)
        pass
