...
class AntennaConfigurationFrame(Tk.LabelFrame):
    ...
    def initialize_widgets(self):
        ...
        self.stepsizePitchMultiplierSpinbox.insert(0, PITCH_MOTOR_MIN_STEP_MULIPLIER - 1)
        self.stepsizeYawMultiplierSpinbox.delete(0,"end")
        self.stepsizeYawMultiplierSpinbox.insert(0, YAW_MOTOR_MIN_STEP_MULIPLIER - 1)
