...
class DataSeries:
    ...
    def __init__(self, name, degreesToScanPitchLowerLimit, degreesToScanPitchUpperLimit, degreesToScanYaw, pitchStepMultiplier, yawStepMultiplier):
        ...
        # steps to scan also represents the final array size
        self.stepsToScanPitch = round((self.degreesToScanPitchUpperLimit - self.degreesToScanPitchLowerLimit) / (systemAttributes.PITCH_MOTOR_STEP_SIZE_IN_DEGREE * self.pitchStepMultiplier))
        self.stepsToScanYaw = round(self.degreesToScanYaw / (systemAttributes.YAW_MOTOR_STEP_SIZE_IN_DEGREE * self.yawStepMultiplier))
    ...
    def getNumberOfArrayEntrys(self):
        return self.stepsToScanYaw * self.stepsToScanPitch
