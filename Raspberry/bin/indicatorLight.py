# ========================================================================
# Title:        IndicatorLight
# Author:       Jonas Buuck, Timo Vandrey
# Date:         07.03.2021
# Description:  Mini custom widget acts like an "led-light"
#
# --< LOG >-----
# 07.03.2021 -> class created by Timo
# ========================================================================

# TODO: HAT N RAND! ENTFERNEN!
...
class IndicatorLight(Tk.Canvas):
    ...
    def configure_self(self):
        self.configure(height=SELF_SIZE_XY, width=SELF_SIZE_XY, bd=-0, relief=None)
        self.grid()
        pass
