...
DEFAULT_ESP_SCAN_TIME_IN_SECONDS = 2.62
...
PITCH_MOTOR_LOWER_LIMIT_IN_DEGREE = -120
...
PITCH_MOTOR_MIN_STEP_MULIPLIER = 1
PITCH_MOTOR_MAX_STEP_MULIPLIER = 100
...
YAW_MOTOR_MAX_STEP_MULIPLIER = 100
